...
export const animatedCards = [
  { title: 'User Experience', text: 'Building an interactive UI/UX keeps users hooked and customers satisfied.', imgSrc: 'user-experience.svg' },
  ...
  { title: 'Quality', text: 'Less bugs leads to a maintainable and flexible system which delivers a high quality product.', imgSrc: 'quality.svg' },
];
